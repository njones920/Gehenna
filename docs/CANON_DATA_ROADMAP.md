...
The current `0.4.23` build is a playable engine seed. Its Ridge of Elah content is a
...
The `0.4.23` build should invite people to clone and play. The next canon milestone
